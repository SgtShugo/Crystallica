...
/**
 * This interface should be defined by any Tile which wants to receive energy
 * from BuildCraft lasers.
 * 
...
public interface ILaserTarget {
	...
	/**
	 * Returns true if the target currently needs power. For example, if the
	 * Advanced Crafting Table has work to do.
	 * 
