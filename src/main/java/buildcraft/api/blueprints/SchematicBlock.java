...
public class SchematicBlock extends SchematicBlockBase {
	...
	@Override
	public void getRequirementsForPlacement(IBuilderContext context,
	...
	@Override
	public void placeInWorld(IBuilderContext context, int x, int y, int z,
	...
	public void storeRequirements(IBuilderContext context, int x, int y, int z) {
		...
		if (block != null) {
			ArrayList<ItemStack> req = block.getDrops(context.world(), x, y, z,
					context.world().getBlockMetadata(x, y, z), 0);
	...
	@Override
	public void readSchematicFromNBT(NBTTagCompound nbt,
	...
	protected void readRequirementsFromNBT(NBTTagCompound nbt,
			MappingRegistry registry) {
		if (nbt.hasKey("rq")) {
	...
	protected void writeRequirementsToNBT(NBTTagCompound nbt,
			MappingRegistry registry) {
		if (storedRequirements.length > 0) {
