...
public interface IReactor {
	...
	/**
	 * Set the reactor's stored maxHeat variable. Used by plating to increase
	 * the reactors MaxHeat capacity. Needs to be called during each cycle
	 * process.
	 */
	public void setMaxHeat(int newMaxHeat);

	/**
	 * add Heat to a EmitHeat Buffer for use in Reactor operation.. need to be
	 * use for all Componetents with self-cooling no more magic heat disappear
	 */

	public void addEmitHeat(int heat);

	/**
	 * Get's the reactor's HEM (Heat Effect Modifier) Basic value is 1.0F.
	 * Reducing the value causes a weakening/reduction of the heat-based
	 * sideeffects of reactors (F.e. water evaporation, melting, damaging
	 * entitys, etc)
	 * 
	 * @return HEM
	 */
	 ...
	 * Get the reactor's energy output.
	 * 
	 * @return Energy output, multiplied with base EU/t value and
	 *         MainConfig.get().getFloat("balance/energy/generator/nuclear")
	 */
	 ...
	 * 
	 * @return Energy output after adding the value, not multiplied by the base
	 *         EU/t value
	 */
	 ...
	 * 
	 * @param x
	 *            X position of the item, out of bounds returns null
	 * @param y
	 *            Y position of the item, out of bounds returns null
	 ...
	 * 
	 * @param x
	 *            X position of the item, out of bounds is a no-op
	 * @param y
	 *            Y position of the item, out of bounds is a no-op
	 * @param item
	 *            The item to set.
	 */
