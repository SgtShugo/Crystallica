...
public interface ICannerBottleRecipeManager {
	 ...
	 *            Filled container
	 */
	public void addRecipe(IRecipeInput container, IRecipeInput fill,
			ItemStack output);
	 ...
	 */
	public RecipeOutput getOutputFor(ItemStack container, ItemStack fill,
			boolean adjustInput, boolean acceptTest);
