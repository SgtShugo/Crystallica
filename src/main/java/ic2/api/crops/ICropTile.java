...
public interface ICropTile {
	...
	/**
	 * Get the crop's plant resistance stat. Higher values indicate more
	 * resistance against trampling.
	 * 
	...
	/**
	 * Get the crop's plant scan level. Increases every time the seed is
	 * analyzed.
	 * 
	...
	/**
	 * Get the crop's plant custom data, stored alongside the crop. Can be
	 * modified in place.
	 * 
	 ...
	 * 
	 * @param nutrientStorage
	 *            Crop nutrient storage
	 */
	public void setNutrientStorage(int nutrientStorage);

	/**
	 * Get the crop's hydration storage. 0 indicates nothing, 1-10 indicate
	 * water hydration and 11-100 for hydration cells.
	 * 
	 ...
	 * 
	 * @param hydrationStorage
	 *            Crop hydration storage
	 */
	 ...
	 * 
	 * @param weedExStorage
	 *            Crop Weed-Ex storage
	 */
	public void setWeedExStorage(int weedExStorage);

	/**
	 * Get the crop's humidity. Ranges from 0 (dry) to 10 (humid). Updates every
	 * couple of seconds or when an update is requested.
	 * 
	 * @see #updateState()
	 * 
	 ...
	 * 
	 * @param manual
	 *            whether it was done by hand (not automated)
	 * @return true if successfully picked
	 */
	public boolean pick(boolean manual);

	/**
	 * Harvest the crop, turning it into gain and resetting its size. drop
	 * output on ground
	 * 
	 * @param manual
	 ...
	 * 
	 * @param Optimal
	 *            force check getOptimalHavestSize() for harvest
	...
	/**
	 * Check if a block is under the farmland containing the crop. Searches up
	 * to 2 blocks below the farmland or an air space, whichever appears first.
	 * 
	 * @param block
	 *            block to search
