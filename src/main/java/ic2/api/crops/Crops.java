...
public abstract class Crops {
	 ...
	 * 
	 * @param type
	 *            Forge biome type to apply the bonus in
	 * @param nutrientsBonus
	 *            Nutrient stat bonus
	 */
	...
	/**
	 * Auto-assign an ID to a plant and register it. Usage of this method is not
	 * recommended! Other plants could take your IDs and cause your plants to
	...
	/**
	 * Attempt to register a plant to an ID. If the ID is taken, the crop will
	 * not be registered and a console print will notify the user.
	 * 
	 * @param crop
	 *            plant to register
	 * @param i
	 *            ID to register the plant to
