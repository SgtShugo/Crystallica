...
public class BlockErzBeryll extends CrystallicaDefaultBlock {

	public BlockErzBeryll(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
	...
	public Item getItemDropped(IBlockState blockstate, Random random, int fortune) {
		return RegisterItemList.ItemKristalleBeryll;
	}
