...
public class BlockErzAquamarin extends CrystallicaDefaultBlock {

	public BlockErzAquamarin(Material material, String unlocalizedName, float hardness, float resistance,
			float lightLevel, String tool, int harvestLevel, int dropzahl) {
	...
	public Item getItemDropped(IBlockState blockstate, Random random, int fortune) {
		return RegisterItemList.ItemKristalleAquamarin;
	}
