...
public class BlockErzMalachit extends CrystallicaDefaultBlock {

	public BlockErzMalachit(Material material, String unlocalizedName, float hardness, float resistance,
	...
	public Item getItemDropped(IBlockState blockstate, Random random, int fortune) {
		return RegisterItemList.ItemKristalleMalachit;
	}
