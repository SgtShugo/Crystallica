...
public class BlockErzRubin extends CrystallicaDefaultBlock {

	public BlockErzRubin(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
	...
	public Item getItemDropped(IBlockState blockstate, Random random, int fortune) {
		return RegisterItemList.ItemKristalleRubin;
	}
