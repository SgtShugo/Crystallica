...
public class BlockErzMythril extends CrystallicaDefaultBlock {

	public BlockErzMythril(Material material, String unlocalizedName, float hardness, float resistance,
	...
	public Item getItemDropped(IBlockState blockstate, Random random, int fortune) {
		return RegisterItemList.ItemKristalleMythril;
	}
