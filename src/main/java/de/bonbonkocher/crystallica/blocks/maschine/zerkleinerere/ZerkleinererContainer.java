...
public class ZerkleinererContainer extends Container
{
    ...
    public ZerkleinererContainer(InventoryPlayer p_i45794_1_, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new ZerkleinererSlotFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new ZerkleinererSlotOutput(p_i45794_1_.player, furnaceInventory, 2, 116, 35));
        int i;
