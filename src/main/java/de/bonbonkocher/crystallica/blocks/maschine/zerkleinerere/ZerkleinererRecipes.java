...
public class ZerkleinererRecipes
{
    private static final ZerkleinererRecipes smeltingBase = new ZerkleinererRecipes();
     ...
     */
    public static ZerkleinererRecipes instance()
    {
        return smeltingBase;
    }

    private ZerkleinererRecipes()
    {
