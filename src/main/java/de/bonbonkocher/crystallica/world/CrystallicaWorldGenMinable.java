...
public class CrystallicaWorldGenMinable extends WorldGenerator 
{

	private IBlockState block;
	private Predicate<IBlockState> target;

	public CrystallicaWorldGenMinable(IBlockState block, Predicate<IBlockState> target)
	{
		this.block = block;
		this.target = target;
	}
	...
	public CrystallicaWorldGenMinable(IBlockState block)
	{
